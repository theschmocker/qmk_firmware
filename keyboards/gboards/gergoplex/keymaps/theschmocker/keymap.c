 ...
 * `------+-----+-----+------+----'      `--------------------------------'
 *  .------------------------.              .-------------------------------.
 *  |ESC/ALT| _SPECIAL | CMD |             | SHIFT/ENT| SPC(_NUMBERS) | TAB |
 *  '-----------------------'              '-------------------------------'
 */
[_ALPHA] = LAYOUT_split_3x5_3(
    ...
    MT(MOD_RSFT, KC_Z),KC_X, KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
 		...
 		MT(MOD_LALT, KC_ESC), MO(_SPECIAL),          KC_LGUI,             // Left
		MT(MOD_LSFT, KC_ENT), LT(_NUMBERS, KC_SPC),  MT(MOD_RSFT, KC_TAB) // Right
    ),
...
[_SPECIAL] = LAYOUT_split_3x5_3(
    KC_EXLM, KC_AT,   KC_TILD, KC_GRV,  KC_PIPE,   KC_PIPE, KC_LCBR, KC_RCBR,  KC_TRNS, KC_BSLS,
...
[_NUMBERS] = LAYOUT_split_3x5_3(
    ...
    KC_F6, KC_F7, KC_F8,  KC_F9,  KC_F10,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_VOLD,
                  KC_F11, KC_F12, KC_MPLY,   KC_TRNS, KC_TRNS, KC_MNXT
    )
};
